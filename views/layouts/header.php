...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">W</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?=Yii::$app->user->identity->profile->getAvatarUrl(50)?>" class="user-image" alt="User Image"/>
                        <span class="hidden-xs"><?=Yii::t('app', 'Profile'); ?></span>
                    </a>
