...
$this->title = Yii::t('app', 'For Clients');
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<h3 class="ourcars__title ourcars__title--page">
						Как заказать автомобиль на сайте
					</h3>
				</div>
				<div class="col-md-12">
					<div class="step-nav">
					...
					<div class="copy-holder">
						<div class="steps-item step-1 active">
							<img class="img-responsive" src="/images/client__step1.jpg" alt="step-1" />
						</div>
						<div class="steps-item step-2">
							<img class="img-responsive" src="/images/client__step2.jpg" alt="step-2" />
						</div>
						<div class="steps-item step-3">
							<img class="img-responsive" src="/images/client__step3.jpg" alt="step-3" />
						</div>
						<div class="steps-item step-4">
							<img class="img-responsive" src="/images/client__step4.jpg" alt="step-4" />
						</div>
					  <div class="steps-item step-5">
							<img class="img-responsive" src="/images/client__step5.jpg" alt="step-5" />
						</div>
					</div>
				</div>
			</div>
